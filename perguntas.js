...
criaCartao(
    'Português',
    'O que é um verbo?',
    'Uma palavra que indica ação, estado ou fenômeno')

criaCartao(
    'Português',
     'O que é um sujeito?',
     'O termo da oração que realiza a ação ou sofre a ação do verbo')
...
criaCartao(
    'Sociologia',
    'O que é cultura?',
    'Conjunto de costumes, tradições e valores de um povo')

criaCartao(
    'Sociologia',
    'O que é estratificação social?',
    'Divisão da sociedade em camadas com diferentes níveis de poder e riqueza')
...
criaCartao(
    'Matemática',
    'Qual é a fórmula do perímetro de um quadrado?',
    'P = 4 x l')
...
criaCartao(
    'Geografia',
    'Qual continente tem a maior população?',
    'Ásia')
